...
(function () {
    ...
    sap.ui.controller("view.KpiTile", {
       ...
       /*     var oTileControl = this.getView().getTileControl();
        ...
        successHandleFn: function (oResult) {
			...
			oDataToDisplay.value1 = parseFloat(oResult.value1);
			oDataToDisplay.value2 = parseFloat(oResult.value2);
			oDataToDisplay.value3 = parseFloat(oResult.value3);
			oDataToDisplay.value4 = parseFloat(oResult.value4);
			oDataToDisplay.value5 = parseFloat(oResult.value5);
			oDataToDisplay.value6 = parseFloat(oResult.value6);
			oDataToDisplay.color1 = oResult.color1;
			oDataToDisplay.color2 = oResult.color2;
			oDataToDisplay.color3 = oResult.color3;
			oDataToDisplay.color4 = oResult.color4;
			oDataToDisplay.color5 = oResult.color5;
			oDataToDisplay.color6 = oResult.color6;
            // set data to display
